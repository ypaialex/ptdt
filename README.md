...
The three files should be found in the /demo folder of the cloned repository. You can also download the three files for the tutorial [here] (https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/ypaialex/ptdt/tree/master/demo). Those files are:
